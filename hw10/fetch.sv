...
logic load_pc, load_mar, load_ir, load_w, movlw, addlw, iorlw, sublw, 
	  ...
	  bcf, bsf, btfsc, btfss, decfsz, incfsz, alu_zero;
logic [3:0] op;
logic [7:0] alu, mux1_out, ram_out, databus, ram_mux, bcf_mux, bsf_mux, btfsc_skip_bit, btfss_skip_bit;
...
begin
	...
	sel_pc = 0; sel_alu = 0; ram_en = 0; sel_bus = 0;
	sel_ram_mux = 0;
	case(ps)
		T0:
		begin
